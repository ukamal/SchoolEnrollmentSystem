...
<div class="container-scroller">
    ...
    <nav class="navbar navbar-light col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="text-center navbar-brand-wrapper">
            <a class="navbar-brand brand-logo" href="{{ url('/dashboard') }}"><img style="width: 60px;" src="{{ asset('public/images/backend_img/logo.png') }}" alt="Logo">
            Kamal Hossen</a>
        </div>
    ...
    <div class="container-fluid page-body-wrapper">
        <div class="row row-offcanvas row-offcanvas-right">
            ...
            <nav class="sidebar sidebar-offcanvas" id="sidebar">
                <div class="user-info">
                    <div class="profile">
                        <img src="{{ asset('public/images/backend_img/admin.png') }}" alt="">
                    </div>
                    <div class="details">
                        <p class="user-name">Full Stack</p>
                ...
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ url('/allStudent/all_student') }}">
                            <i class="mdi mdi-gauge menu-icon"></i>
                            <span class="menu-title">All Student</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ url('/allStudent/add_student') }}">
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="layoutsSubmenu">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ url('/allStudent/tution_fee') }}">Tution Fee</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ url('/result') }}">Result</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="pages/layout/horizontal-menu.html"></a>
                                </li>
                            </ul>
                        </div>
                    </li>
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="sidebar_layouts">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ url('/bss') }}">BSS</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ url('/ba') }}">BA</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ url('/bsc') }}">BSC</a>
                                </li>
                                <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="collapse" href="#authSubmenu" aria-expanded="false" aria-controls="authSubmenu">
                            ...
                            <span class="menu-title">Teacher's</span>
                            <i class="mdi mdi-chevron-down menu-arrow"></i>
                        </a>
